...
const ETAPES = [
  ...
  },
  {
    ...
    options: [
      ...
      { emoji: "💃", label: "Un effeuillage pour toi", desc: "Je danse rien que pour tes yeux" },
      { emoji: "👀", label: "Tu me regardes",        desc: "Je me fais plaisir, tu profites du spectacle" },
  ...
  },
  {
    ...
    options: [
      ...
      { emoji: "🪝", label: "Jouet à ventouse (au mur)", desc: "Tu le poses, tu t'en sers… je regarde 😏" },
      { emoji: "🩹", label: "Bandeau sur les yeux",     desc: "On joue avec le mystère" },
      { emoji: "🪶", label: "Plumes & caresses",        desc: "Frissons garantis" },
