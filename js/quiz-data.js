...
const ETAPES = [
  ...
  },
  {
    ...
    options: [
      ...
      { emoji: "💃", label: "Je danse pour toi",       desc: "Un effeuillage rien que pour tes yeux" },
      { emoji: "💋", label: "Je joue avec mes doigts", desc: "Je me caresse, tu me regardes" },
      { emoji: "🔥", label: "La totale, tu me regardes", desc: "Je danse, je me caresse et j'utilise les jouets" },
      { emoji: "🌷", label: "Comme à Amsterdam",       desc: "Ambiance vitrine : je me montre rien que pour toi" },
  ...
  },
  {
    ...
    options: [
      ...
      { emoji: "🪝", label: "Jouet à ventouse (au mur)", desc: "Je le fixe au mur et je m'en sers… tu regardes 😏" },
