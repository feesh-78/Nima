...
const ETAPES = [
  ...
  },
  {
    ...
    hint: "On ne sera pas à la maison le soir : c'est à toi de choisir. Classe tes envies (ou propose).",
    multi: true,
    allowOther: true,
    allowRefus: true,
    otherPlaceholder: "Autre : ton envie, le resto qui te tente…",
    options: [
      { emoji: "🍗", label: "Poulet Yassa",   desc: "Ouest-africain" },
      { emoji: "🥜", label: "Mafé",           desc: "Ouest-africain" },
      { emoji: "🍚", label: "Jollof rice",    desc: "Ouest-africain" },
      { emoji: "🍜", label: "Nouilles / wok", desc: "Asiatique" },
      { emoji: "🍣", label: "Sushis",         desc: "Asiatique" },
      { emoji: "🍛", label: "Curry",          desc: "Asiatique" },
      { emoji: "🙋", label: "C'est à toi de choisir", desc: "On sera dehors : choisis ce qui te tente" },
    ],
  },
  {
